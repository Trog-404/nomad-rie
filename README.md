...
```sh
git clone https://github.com/foo/Rie_schema.git
cd Rie_schema
...
```sh
pip install dist/Rie_schema-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Matteo Bontorno | [bontornomatteo@gmail.com](mailto:bontornomatteo@gmail.com)
